...
Partial Class Forms_frmVWFotografias
    ...
    Protected Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        Dim permMAudiovisual As New Permisos(User.Identity.Name, "MFotografias.aspx")
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Functions.Images("FOTOGRAFIA", GridView1.DataKeys(e.Row.RowIndex).Value) = 0 Then
