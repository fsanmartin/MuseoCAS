...
Partial Class Forms_frmVWObjetos
    ...
    Protected Sub GridView1_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GridView1.RowDataBound
        Dim permMAudiovisual As New Permisos(User.Identity.Name, "MObjetos.aspx")
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Functions.Images("OBJETOS", GridView1.DataKeys(e.Row.RowIndex).Value) = 0 Then
